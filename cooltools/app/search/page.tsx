              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select 
                    ...
                    onChange={(e) => setFilters({...filters, ramMin: e.target.value})}
                  >
                ...
                <div>
                  ...
                  <select 
                    ...
                    onChange={(e) => setFilters({...filters, displaySize: e.target.value})}
                  >
                    <option value="">Any</option>
                ...
                <div>
                  ...
                  <select 
                    ...
                    onChange={(e) => setFilters({...filters, refreshRate: e.target.value})}
                  >
                    <option value="">Any</option>
                ...
                <div>
                  ...
                  <select 
                    ...
                    onChange={(e) => setFilters({...filters, battery: e.target.value})}
                  >
                    <option value="">Any</option>
          ...
          <div className="lg:col-span-3">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-lg text-center">
              ...
              <p className="text-gray-500 dark:text-gray-500">
                Use the advanced filters on the left to find phones matching your criteria
              </p>
              
              <div className="mt-8 grid md:grid-cols-2 gap-4 text-left">
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                  <h3 className="font-semibold text-blue-900 dark:text-blue-100 mb-2">150+ Filter Options</h3>
                ...
                <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
                  <h3 className="font-semibold text-purple-900 dark:text-purple-100 mb-2">Smart Features</h3>
